...
const selectItemsSection = (id) => {
    ...
    if (document.querySelector('#button-service-garden').classList.contains('active') && document.querySelector('#button-service-lawn').classList.contains('active') && document.querySelector('#button-service-planting').classList.contains('active')) {
        noBlurAllItemService();
        deActiveButtonService();
    }
}
